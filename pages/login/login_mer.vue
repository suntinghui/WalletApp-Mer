<template>
	<view class="login">
		<view class="content">
			...
			<!-- 主体表单 -->
			<view class="main">
				<wInput v-model="bussinessLicenseCode" type="text" maxlength="11" placeholder="营业执照号"></wInput>
				<wInput v-model="bussinessLicenseName" type="text" maxlength="11" placeholder="营业执照名称"></wInput>
				<wInput v-model="customerWorkNbr" type="text" maxlength="11" placeholder="员工编号"></wInput>
				<wInput v-model="loginPassword" type="password" maxlength="11" placeholder="登录密码"></wInput>
			</view>
				...
				uni.request({
					...
					success: (res) => {
						...
						if (res.data.code == "B0000") {
							this.updateToken(res.header.token);
							this.enterHome();
						} else {
