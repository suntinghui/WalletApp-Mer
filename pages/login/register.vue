<template>
	<view class="register">
		...
		<view class="content">
			...
			<wButton text="注 册" @click.native="startReg()"></wButton>

			<!-- 底部信息 -->
			<view class="footer">
				<text @tap="isShowAgree" class="cuIcon" :class="showAgree?'cuIcon-radiobox':'cuIcon-round'">开始注册即表示您同意</text>
				<!-- 协议地址 -->
				<navigator :url="'../common/webpage?url='+encodeURIComponent('https://caiyun.feixin.10086.cn/agreement.jsp')"
				 open-type="navigate">《用户协议》</navigator>
			</view>
		</view>
	</view>
</template>
