<template>
	<view>
		...
		<view class="padding flex flex-direction">
			<button class="cu-btn bg-red margin-tb-sm lg" @tap="showModal">退货</button>
		</view>
		
		<best-payment-password :show="payFlag" :value="paymentPwd" :forget="false" digits="6" @submit="checkPwd" @cancel="togglePayment"></best-payment-password>
